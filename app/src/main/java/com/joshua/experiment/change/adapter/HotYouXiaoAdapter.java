package com.joshua.experiment.change.adapter;
...
public class HotYouXiaoAdapter extends RecyclerView.Adapter<HotYouXiaoAdapter.MyViewHolder> implements View.OnClickListener {
    private LayoutInflater mInflater;
    private Context mContext;
    private List<HotYouXiao> data = new ArrayList<>();

    public HotYouXiaoAdapter(Context context, List<HotYouXiao> data) {
